...
| <a name="input_brand_short"></a> [brand\_short](#input\_brand\_short) | Short name of the brand/client, eg. wal, cor, sec | `string` | `"b1"` | no |
...
| <a name="input_vnet_address_space"></a> [vnet\_address\_space](#input\_vnet\_address\_space) | Set of strings containing the vnet address space. | `set(string)` | <pre>[<br/>  "10.1.0.0/24"<br/>]</pre> | no |
